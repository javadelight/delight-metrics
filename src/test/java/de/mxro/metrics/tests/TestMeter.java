...
public class TestMeter {
  ...
  public void test_count() {
    ...
    PromiseTemplate<Object> _retrieve = m.retrieve("de.mxro.test.meter1");
    ...
    PromiseTemplate<Success> _stop = m.stop();
    _stop.get();
  }
  ...
  public void test_rates() {
    try {
      ...
      PromiseTemplate<Meter> _retrieve = m.<Meter>retrieve("de.mxro.test.meter1", Meter.class);
      ...
      PromiseTemplate<Meter> _retrieve_1 = m.<Meter>retrieve("de.mxro.test.meter1", Meter.class);
